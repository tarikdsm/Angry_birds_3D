...
const FORMAT_TOKENS := {
	...
	"hud.multiplier": ["%s"],
	"hud.stars": ["%d"],
	"hud.queue.entry": ["%s", "%s", "%s"],
	"hud.material.entry": ["%s", "%s"],
	"hud.ability.entry": ["%s", "%s"],
	"hud.controls.hint": ["%s", "%s", "%s"],
	"app.result.score": ["%d"],
	"app.result.stars": ["%d"],
...
const REQUIRED_MESSAGE_IDS := [
	...
	"hud.objectives", "hud.score", "hud.multiplier", "hud.stars",
	"hud.queue.title", "hud.queue.entry", "hud.queue.empty",
	"hud.plane.locked", "hud.plane.free",
	"hud.state.loading", "hud.state.ready", "hud.state.active",
	"hud.state.spent", "hud.state.waiting",
	"hud.bird.virela", "hud.bird.red", "hud.bird.yellow", "hud.bird.blue",
	"hud.bird.black",
	"hud.ability.gravity_field", "hud.ability.mass_boost", "hud.ability.speed_boost",
	"hud.ability.split", "hud.ability.explosion", "hud.ability.entry",
	"hud.material.title", "hud.material.entry", "hud.material.pine",
	"hud.material.brick", "hud.material.glass", "hud.material.pressed_straw",
	"hud.material.sheet_steel",
	"hud.assist.enabled", "hud.assist.disabled", "hud.controls.hint",
	"app.pause.title", "app.pause.resume", "app.pause.restart", "app.pause.options",
	"app.pause.level_select", "app.pause.main_menu",
	"app.result.victory", "app.result.defeat", "app.result.score", "app.result.stars",
	"app.result.birds_used", "app.result.new_record", "app.result.restart",
	"app.result.level_select", "app.result.continue",
	"app.gameplay.launch_failed",
]
