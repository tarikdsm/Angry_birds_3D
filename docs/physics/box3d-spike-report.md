...
| `/tested_inputs/7/size_bytes` | `3567` |
| `/tested_inputs/7/sha256` | `"697f38e9980865286c11fb2161edb84b0918f140aeda5cb92f34408f2a4928b1"` |
...
| `/tested_inputs/17/path` | `"native/extension/tests/orbital_session_adapter_tests.cpp"` |
| `/tested_inputs/17/mode` | `"text_utf8_lf"` |
| `/tested_inputs/17/size_bytes` | `9485` |
| `/tested_inputs/17/sha256` | `"1356b5a30edccbd48c3bfa4816cb39da662bd87a5288e27a8849b28793a4d371"` |
| `/tested_inputs/18/path` | `"native/extension/tests/registration_contract_tests.cpp"` |
| `/tested_inputs/18/mode` | `"text_utf8_lf"` |
| `/tested_inputs/18/size_bytes` | `856` |
| `/tested_inputs/18/sha256` | `"e4a69e3ab72e5b88e660740f5b3309be3e5f46cb14f02e2c08c6175a92715c4b"` |
| `/tested_inputs/19/path` | `"native/extension/tests/session_frame_batch_tests.cpp"` |
| `/tested_inputs/19/mode` | `"text_utf8_lf"` |
| `/tested_inputs/19/size_bytes` | `8254` |
| `/tested_inputs/19/sha256` | `"007856c724bba9cdcb81a79b192284ba55e7e0be2adde11ddaa4cbb6ee1e37e4"` |
| `/tested_inputs/20/path` | `"native/kernel/CMakeLists.txt"` |
| `/tested_inputs/20/mode` | `"text_utf8_lf"` |
| `/tested_inputs/20/size_bytes` | `1007` |
| `/tested_inputs/20/sha256` | `"2f7a6f92d53b6c9975e1175915e14e86f730935661aa3a1a691bb62f370b3323"` |
| `/tested_inputs/21/path` | `"native/kernel/include/ninho/physics/physics_limits.hpp"` |
| `/tested_inputs/21/mode` | `"text_utf8_lf"` |
| `/tested_inputs/21/size_bytes` | `105` |
| `/tested_inputs/21/sha256` | `"fa4ee6c1ecfae90e16a1ac8531a9f2012280798fd1dd70afe62c60e6b171f4ec"` |
| `/tested_inputs/22/path` | `"native/kernel/include/ninho/physics/physics_types.hpp"` |
| `/tested_inputs/22/mode` | `"text_utf8_lf"` |
| `/tested_inputs/22/size_bytes` | `2698` |
| `/tested_inputs/22/sha256` | `"2c795c1c946675998cc41da2a80d909d04b06d14e4efdf222c630c3ede1cf4b3"` |
| `/tested_inputs/23/path` | `"native/kernel/include/ninho/physics/physics_world.hpp"` |
| `/tested_inputs/23/mode` | `"text_utf8_lf"` |
| `/tested_inputs/23/size_bytes` | `6642` |
| `/tested_inputs/23/sha256` | `"0b344d5251a6ccb14c4d6dd9f09ecf9fb93d2d95bd5a60ec9b6f857e960c48a7"` |
| `/tested_inputs/24/path` | `"native/kernel/include/ninho/physics/radial_gravity.hpp"` |
| `/tested_inputs/24/mode` | `"text_utf8_lf"` |
| `/tested_inputs/24/size_bytes` | `763` |
| `/tested_inputs/24/sha256` | `"14af0b3aa42a1e26ec1bd6036c97da97d1371b5aa15ae6a32a877a526b905db2"` |
| `/tested_inputs/25/path` | `"native/kernel/include/ninho/physics/scenario.hpp"` |
| `/tested_inputs/25/mode` | `"text_utf8_lf"` |
| `/tested_inputs/25/size_bytes` | `13527` |
| `/tested_inputs/25/sha256` | `"c0d8a789c0b91cf00395308c640a8e02fb903731382ab270b42cd1c4bce6a821"` |
| `/tested_inputs/26/path` | `"native/kernel/src/box3d_allocator_probe.cpp"` |
| `/tested_inputs/26/mode` | `"text_utf8_lf"` |
| `/tested_inputs/26/size_bytes` | `213` |
| `/tested_inputs/26/sha256` | `"3a408601664e8e8af5635fd141ee7c724e2c2458e5062aad0b7baf3941d152e2"` |
| `/tested_inputs/27/path` | `"native/kernel/src/box3d_allocator_probe.hpp"` |
| `/tested_inputs/27/mode` | `"text_utf8_lf"` |
| `/tested_inputs/27/size_bytes` | `337` |
| `/tested_inputs/27/sha256` | `"5bf393d6cde5cf02db2f790ff162aba33e190d1768102466ecfe5c1616d7be4b"` |
| `/tested_inputs/28/path` | `"native/kernel/src/box3d_conversions.hpp"` |
| `/tested_inputs/28/mode` | `"text_utf8_lf"` |
| `/tested_inputs/28/size_bytes` | `1216` |
| `/tested_inputs/28/sha256` | `"563b1e1e9a33ab7a0bdbec198c97a0bc227221b4512d77d34fd8b14feae8a877"` |
| `/tested_inputs/29/path` | `"native/kernel/src/box3d_replay_conformance.cpp"` |
| `/tested_inputs/29/mode` | `"text_utf8_lf"` |
| `/tested_inputs/29/size_bytes` | `3833` |
| `/tested_inputs/29/sha256` | `"bc90cf1b14738b6dc897fa1b77f65b8d60530ecdbcde11d4753b29f4dfecb8cc"` |
| `/tested_inputs/30/path` | `"native/kernel/src/box3d_replay_conformance.hpp"` |
| `/tested_inputs/30/mode` | `"text_utf8_lf"` |
| `/tested_inputs/30/size_bytes` | `403` |
| `/tested_inputs/30/sha256` | `"607a01759002816a48ace7361ee82e26d2a6b20438dc32eac2dec306e110f8c3"` |
| `/tested_inputs/31/path` | `"native/kernel/src/physics_world.cpp"` |
| `/tested_inputs/31/mode` | `"text_utf8_lf"` |
| `/tested_inputs/31/size_bytes` | `67137` |
| `/tested_inputs/31/sha256` | `"da655462e410c3f6473fa3a9a6fd9135c193658c6bdd4f9eea874ca8c68f5a3d"` |
| `/tested_inputs/32/path` | `"native/kernel/src/physics_world_test_facade.hpp"` |
| `/tested_inputs/32/mode` | `"text_utf8_lf"` |
| `/tested_inputs/32/size_bytes` | `420` |
| `/tested_inputs/32/sha256` | `"7ddb6c079257a4e7c1a245fa043b54ab6d473d364eec3fa803a99b9afe913b2b"` |
| `/tested_inputs/33/path` | `"native/kernel/src/radial_gravity.cpp"` |
| `/tested_inputs/33/mode` | `"text_utf8_lf"` |
| `/tested_inputs/33/size_bytes` | `1863` |
| `/tested_inputs/33/sha256` | `"ef20acd6f17034cf8c5b017137796bea945fb9910d5c7ec7b8eff941b7b1ab46"` |
| `/tested_inputs/34/path` | `"native/kernel/src/scenario.cpp"` |
| `/tested_inputs/34/mode` | `"text_utf8_lf"` |
| `/tested_inputs/34/size_bytes` | `166432` |
| `/tested_inputs/34/sha256` | `"3349eb04913719a7f77229722333e894c290afa7d2ee592d89bf9b638916b90a"` |
| `/tested_inputs/35/path` | `"native/kernel/src/scenario_configuration.hpp"` |
| `/tested_inputs/35/mode` | `"text_utf8_lf"` |
| `/tested_inputs/35/size_bytes` | `1014` |
| `/tested_inputs/35/sha256` | `"1dce7723604301a83b37349f8a42969bfea8baa3ebe4a7c5b8ac3e9445331f7c"` |
| `/tested_inputs/36/path` | `"native/kernel/src/scenario_test_facade.hpp"` |
| `/tested_inputs/36/mode` | `"text_utf8_lf"` |
| `/tested_inputs/36/size_bytes` | `359` |
| `/tested_inputs/36/sha256` | `"161de04d8c791b5294c47d4a5a959384ce5f566584188c72ba984a4a9a16a1c0"` |
| `/tested_inputs/37/path` | `"native/simulation/CMakeLists.txt"` |
| `/tested_inputs/37/mode` | `"text_utf8_lf"` |
| `/tested_inputs/37/size_bytes` | `4362` |
| `/tested_inputs/37/sha256` | `"32863b3949d68f34eadeeef964c29cd31c3769dca3ca61be5192216cbb28b146"` |
| `/tested_inputs/38/path` | `"native/simulation/include/ninho/simulation/commands.hpp"` |
| `/tested_inputs/38/mode` | `"text_utf8_lf"` |
| `/tested_inputs/38/size_bytes` | `906` |
| `/tested_inputs/38/sha256` | `"be02293941c60d0e4d598a13bfb789a14515d77d0d977be83b1d657a5162537d"` |
| `/tested_inputs/39/path` | `"native/simulation/include/ninho/simulation/content.hpp"` |
| `/tested_inputs/39/mode` | `"text_utf8_lf"` |
| `/tested_inputs/39/size_bytes` | `7629` |
| `/tested_inputs/39/sha256` | `"575de7bd5a6a12a636197ba384cd22a3efc48e52069f496f148332ab3320b114"` |
| `/tested_inputs/40/path` | `"native/simulation/include/ninho/simulation/events.hpp"` |
| `/tested_inputs/40/mode` | `"text_utf8_lf"` |
| `/tested_inputs/40/size_bytes` | `1675` |
| `/tested_inputs/40/sha256` | `"b26bcbcb85c59394ade20e65f889976e0994fd17fe68dcfba6ad868d553591d5"` |
| `/tested_inputs/41/path` | `"native/simulation/include/ninho/simulation/session.hpp"` |
| `/tested_inputs/41/mode` | `"text_utf8_lf"` |
| `/tested_inputs/41/size_bytes` | `5196` |
| `/tested_inputs/41/sha256` | `"eb2b6a7261c322d71cd6a7e0680936282d6fb989923977f32222c0c72dd75205"` |
| `/tested_inputs/42/path` | `"native/simulation/src/canonical_state.cpp"` |
| `/tested_inputs/42/mode` | `"text_utf8_lf"` |
| `/tested_inputs/42/size_bytes` | `22123` |
| `/tested_inputs/42/sha256` | `"7db3a11f11ca40880c4689824341a9870803d39eaffdd4d90caff154671b0f7a"` |
| `/tested_inputs/43/path` | `"native/simulation/src/content.cpp"` |
| `/tested_inputs/43/mode` | `"text_utf8_lf"` |
| `/tested_inputs/43/size_bytes` | `63519` |
| `/tested_inputs/43/sha256` | `"1a92c0529f66cdd8a762cff1c93ae52be4276faab3ee1986a7118eeb2c600020"` |
| `/tested_inputs/44/path` | `"native/simulation/src/damage_system.cpp"` |
| `/tested_inputs/44/mode` | `"text_utf8_lf"` |
| `/tested_inputs/44/size_bytes` | `12792` |
| `/tested_inputs/44/sha256` | `"263bfb2aecf4100cda01f2e5a9b0b6d3220ff6193a10680f338bac8871dbe963"` |
| `/tested_inputs/45/path` | `"native/simulation/src/damage_system.hpp"` |
| `/tested_inputs/45/mode` | `"text_utf8_lf"` |
| `/tested_inputs/45/size_bytes` | `2015` |
| `/tested_inputs/45/sha256` | `"3ec71c08d1347854cae553be7f75269fa011b47f94958974836efbf6a6eb1b17"` |
| `/tested_inputs/46/path` | `"native/simulation/src/fracture_system.cpp"` |
| `/tested_inputs/46/mode` | `"text_utf8_lf"` |
| `/tested_inputs/46/size_bytes` | `15180` |
| `/tested_inputs/46/sha256` | `"0d19385c9256476cdc2c3773eedbcce8663f07405997507c1fbc29c3649ee960"` |
| `/tested_inputs/47/path` | `"native/simulation/src/gravity_field_ability_system.cpp"` |
| `/tested_inputs/47/mode` | `"text_utf8_lf"` |
| `/tested_inputs/47/size_bytes` | `6488` |
| `/tested_inputs/47/sha256` | `"f49f549bea6f67065f78a7aca587b539e760e3f9b477ad3c8285eca155a61735"` |
| `/tested_inputs/48/path` | `"native/simulation/src/launch_system.cpp"` |
| `/tested_inputs/48/mode` | `"text_utf8_lf"` |
| `/tested_inputs/48/size_bytes` | `25197` |
| `/tested_inputs/48/sha256` | `"32709496fcdbb14cac7982052dfd7c41f8503ba13feea0fa3cf409700bcee14d"` |
| `/tested_inputs/49/path` | `"native/simulation/src/material_mapping.hpp"` |
| `/tested_inputs/49/mode` | `"text_utf8_lf"` |
| `/tested_inputs/49/size_bytes` | `609` |
| `/tested_inputs/49/sha256` | `"bfc3f67e77dfec752fbf0f745a721475d0ed3f26dd4fcf865571306366542fcf"` |
| `/tested_inputs/50/path` | `"native/simulation/src/objective_system.cpp"` |
| `/tested_inputs/50/mode` | `"text_utf8_lf"` |
| `/tested_inputs/50/size_bytes` | `899` |
| `/tested_inputs/50/sha256` | `"82528ac4de52229c59b9d5773fbd6ae6de276692131f1a795d119c44c03e7356"` |
| `/tested_inputs/51/path` | `"native/simulation/src/session.cpp"` |
| `/tested_inputs/51/mode` | `"text_utf8_lf"` |
| `/tested_inputs/51/size_bytes` | `16157` |
| `/tested_inputs/51/sha256` | `"4ba94a74b769618e962717b86adb7a8bdbb706b2b6ee653e4112d6f95ecd760a"` |
| `/tested_inputs/52/path` | `"native/simulation/src/session_builder.cpp"` |
| `/tested_inputs/52/mode` | `"text_utf8_lf"` |
| `/tested_inputs/52/size_bytes` | `17518` |
| `/tested_inputs/52/sha256` | `"67c1ea77e1034340e253b46f9060c43fd5d2f5fed56ace8efd875f1f226714b2"` |
| `/tested_inputs/53/path` | `"native/simulation/src/session_internal.hpp"` |
| `/tested_inputs/53/mode` | `"text_utf8_lf"` |
| `/tested_inputs/53/size_bytes` | `6467` |
| `/tested_inputs/53/sha256` | `"670bd18fe94ecee1c6e3282bff050368e8f87e141ce5722a1ac8bd3caaf4853b"` |
| `/tested_inputs/54/path` | `"native/simulation/src/session_test_facade.hpp"` |
| `/tested_inputs/54/mode` | `"text_utf8_lf"` |
| `/tested_inputs/54/size_bytes` | `3042` |
| `/tested_inputs/54/sha256` | `"fecb6cd51c6fefba0adc238f04bdfc56dc429043b4a00e6ab07b0afcc7890679"` |
| `/tested_inputs/55/path` | `"native/simulation/tests/content_tests.cpp"` |
| `/tested_inputs/55/mode` | `"text_utf8_lf"` |
| `/tested_inputs/55/size_bytes` | `35677` |
| `/tested_inputs/55/sha256` | `"796a08013d6651a274acdaadb97f3f6eb9d1a20f218816c87edfbfab160ddddf"` |
| `/tested_inputs/56/path` | `"native/simulation/tests/damage_anchor_tests.cpp"` |
| `/tested_inputs/56/mode` | `"text_utf8_lf"` |
| `/tested_inputs/56/size_bytes` | `20494` |
| `/tested_inputs/56/sha256` | `"598f040d12c0c691bb6d7e21c783309c35722710a82e458d60f9e23ffde9bade"` |
| `/tested_inputs/57/path` | `"native/simulation/tests/fracture_objective_tests.cpp"` |
| `/tested_inputs/57/mode` | `"text_utf8_lf"` |
| `/tested_inputs/57/size_bytes` | `13161` |
| `/tested_inputs/57/sha256` | `"215c55898dde48408ffaac0a567797c5db5e0e1b039ffb0c489bc621e4eac1a7"` |
| `/tested_inputs/58/path` | `"native/simulation/tests/gravity_field_ability_tests.cpp"` |
| `/tested_inputs/58/mode` | `"text_utf8_lf"` |
| `/tested_inputs/58/size_bytes` | `23041` |
| `/tested_inputs/58/sha256` | `"300c30eb6018254854d066933b254fd47ad20e92f10a805397657303ff10e9e7"` |
| `/tested_inputs/59/path` | `"native/simulation/tests/kernel_contract_tests.cpp"` |
| `/tested_inputs/59/mode` | `"text_utf8_lf"` |
| `/tested_inputs/59/size_bytes` | `2743` |
| `/tested_inputs/59/sha256` | `"8882676ade374cdf8b76d1866e47e4adeeaf76c78f664002c5c5be093b5eae85"` |
| `/tested_inputs/60/path` | `"native/simulation/tests/launch_fsm_tests.cpp"` |
| `/tested_inputs/60/mode` | `"text_utf8_lf"` |
| `/tested_inputs/60/size_bytes` | `34247` |
| `/tested_inputs/60/sha256` | `"60bf5278a375a18024aa2adb8bec7e3dc2d98602b31602f1cc9adfcb355f089f"` |
| `/tested_inputs/61/path` | `"native/simulation/tests/playthrough_tests.cpp"` |
| `/tested_inputs/61/mode` | `"text_utf8_lf"` |
| `/tested_inputs/61/size_bytes` | `20246` |
| `/tested_inputs/61/sha256` | `"d0d0987f9ab8dca70d6f18cb185bf84ee7eabff2f3ff21f56e2cec382e6575f9"` |
| `/tested_inputs/62/path` | `"native/simulation/tests/session_tests.cpp"` |
| `/tested_inputs/62/mode` | `"text_utf8_lf"` |
| `/tested_inputs/62/size_bytes` | `41736` |
| `/tested_inputs/62/sha256` | `"1a8ee368a9e0bb3afb69fa58f2579dbbe0870ed7a55c07ea6953ff21fc698ec7"` |
| `/tested_inputs/63/path` | `"native/simulation/tests/test_framework.hpp"` |
| `/tested_inputs/63/mode` | `"text_utf8_lf"` |
| `/tested_inputs/63/size_bytes` | `1870` |
| `/tested_inputs/63/sha256` | `"a2dcdad0a827c7f557a891e8dbf2aa131f9f377f1176f14f1110ccc87079cc77"` |
| `/tested_inputs/64/path` | `"native/simulation/tests/test_main.cpp"` |
| `/tested_inputs/64/mode` | `"text_utf8_lf"` |
| `/tested_inputs/64/size_bytes` | `1240` |
| `/tested_inputs/64/sha256` | `"0fe1a9742c2b031787df553caa0d1d513decea1dd45c1ef3054eb23a640dddfb"` |
| `/tested_inputs/65/path` | `"native/spike/CMakeLists.txt"` |
| `/tested_inputs/65/mode` | `"text_utf8_lf"` |
| `/tested_inputs/65/size_bytes` | `518` |
| `/tested_inputs/65/sha256` | `"4244861de1fc0f84e85e96d44cbd5e6f1eb9c877b31a743c7c6660c5b3fdf3bd"` |
| `/tested_inputs/66/path` | `"native/spike/main.cpp"` |
| `/tested_inputs/66/mode` | `"text_utf8_lf"` |
| `/tested_inputs/66/size_bytes` | `13396` |
| `/tested_inputs/66/sha256` | `"e72ceeab9c929bf6fee638de840a9eac8fe074681c3517e023c094ee4374cbdd"` |
| `/tested_inputs/67/path` | `"native/tests/CMakeLists.txt"` |
| `/tested_inputs/67/mode` | `"text_utf8_lf"` |
| `/tested_inputs/67/size_bytes` | `4134` |
| `/tested_inputs/67/sha256` | `"d36e5eebdf52db4c8fa4d6fb00e5bce434440ebefcfdb9950fb6ef0ce9bd9e22"` |
| `/tested_inputs/68/path` | `"native/tests/capability_tests.cpp"` |
| `/tested_inputs/68/mode` | `"text_utf8_lf"` |
| `/tested_inputs/68/size_bytes` | `27540` |
| `/tested_inputs/68/sha256` | `"d495449638982624fae7d6b5ad98bbb8461dce45383175832f77ce23c50877a1"` |
| `/tested_inputs/69/path` | `"native/tests/determinism_tests.cpp"` |
| `/tested_inputs/69/mode` | `"text_utf8_lf"` |
| `/tested_inputs/69/size_bytes` | `13429` |
| `/tested_inputs/69/sha256` | `"0798f4b49c3cc52796d498d90062ee16eb85653c28335e11444c581d83399095"` |
| `/tested_inputs/70/path` | `"native/tests/json_smoke.py"` |
| `/tested_inputs/70/mode` | `"text_utf8_lf"` |
| `/tested_inputs/70/size_bytes` | `18266` |
| `/tested_inputs/70/sha256` | `"0ec7e8dcb533806ecafb810d25b5c68be8d22e964d76e676625b713d7204915b"` |
| `/tested_inputs/71/path` | `"native/tests/pile_stability_tests.cpp"` |
| `/tested_inputs/71/mode` | `"text_utf8_lf"` |
| `/tested_inputs/71/size_bytes` | `19530` |
| `/tested_inputs/71/sha256` | `"d37aa0e19bdb2cc0517feb62b664dd96b948e8f762499e11cb250e6271a01e5e"` |
| `/tested_inputs/72/path` | `"native/tests/projectile_ccd_tests.cpp"` |
| `/tested_inputs/72/mode` | `"text_utf8_lf"` |
| `/tested_inputs/72/size_bytes` | `5898` |
| `/tested_inputs/72/sha256` | `"7a620a39da06923e1b7ef5eedd8d49aefe6c6f66e414431cce409093232478d5"` |
| `/tested_inputs/73/path` | `"native/tests/radial_gravity_tests.cpp"` |
| `/tested_inputs/73/mode` | `"text_utf8_lf"` |
| `/tested_inputs/73/size_bytes` | `6247` |
| `/tested_inputs/73/sha256` | `"e9732b98d3c545af0d0a6067c566c5767e50f4d3d54b4042c5c675653919d278"` |
| `/tested_inputs/74/path` | `"native/tests/scenario_capability_tests.cpp"` |
| `/tested_inputs/74/mode` | `"text_utf8_lf"` |
| `/tested_inputs/74/size_bytes` | `12233` |
| `/tested_inputs/74/sha256` | `"da0b07669a5499b56b758a7c3ae07150d9b83af1e375cf13d3f529ab63519191"` |
| `/tested_inputs/75/path` | `"native/tests/test_framework.hpp"` |
| `/tested_inputs/75/mode` | `"text_utf8_lf"` |
| `/tested_inputs/75/size_bytes` | `3899` |
| `/tested_inputs/75/sha256` | `"76e694857c118ca7d3007d349637a52bf9b321228fdd81a8408f9547b81ee1e6"` |
| `/tested_inputs/76/path` | `"native/tests/test_main.cpp"` |
| `/tested_inputs/76/mode` | `"text_utf8_lf"` |
| `/tested_inputs/76/size_bytes` | `2566` |
| `/tested_inputs/76/sha256` | `"372df787fbb6fae307ba0ee2c862ef043913b264760358e86ce81903eb9b4626"` |
| `/tested_inputs/77/path` | `"native/tests/world_lifecycle_tests.cpp"` |
| `/tested_inputs/77/mode` | `"text_utf8_lf"` |
| `/tested_inputs/77/size_bytes` | `12095` |
...
| `/tested_inputs/79/sha256` | `"82319b1f009954a5632b7991d4ca291091d2619d762ff5df44b4cc0330857b32"` |
| `/tested_inputs/80/path` | `"tools/GodotSpikeGate.psm1"` |
| `/tested_inputs/80/mode` | `"text_utf8_lf"` |
| `/tested_inputs/80/size_bytes` | `11080` |
| `/tested_inputs/80/sha256` | `"f81ed257e02861aa6f84aace45d39f33d51ceef740d09f149d5c0363087f4b1c"` |
| `/tested_inputs/81/path` | `"tools/Invoke-Native.ps1"` |
| `/tested_inputs/81/mode` | `"text_utf8_lf"` |
| `/tested_inputs/81/size_bytes` | `2185` |
| `/tested_inputs/81/sha256` | `"4cba4036cbc5007bddb3762f5b1c45f72fc63ef63d6b6dbb16c8b0a6ed9344d4"` |
| `/tested_inputs/82/path` | `"tools/SafePath.psm1"` |
| `/tested_inputs/82/mode` | `"text_utf8_lf"` |
| `/tested_inputs/82/size_bytes` | `1841` |
| `/tested_inputs/82/sha256` | `"d6a5c2daeeb3ef4369daa35bf21d6dc60c3ec736ab8c932078b3e24bd32e4ffc"` |
| `/tested_inputs/83/path` | `"tools/SpikeEvidenceValidation.psm1"` |
| `/tested_inputs/83/mode` | `"text_utf8_lf"` |
| `/tested_inputs/83/size_bytes` | `51353` |
| `/tested_inputs/83/sha256` | `"847f52d2501bf25b5136797e71600c4934bf1c03b9ba454f483e73422bd1ddd9"` |
| `/tested_inputs/84/path` | `"tools/SpikeReportGate.psm1"` |
| `/tested_inputs/84/mode` | `"text_utf8_lf"` |
| `/tested_inputs/84/size_bytes` | `2400` |
| `/tested_inputs/84/sha256` | `"762cc1cd1e6740f4eb5745511d9a565a11d7835bac863f71374e44ded9c11077"` |
| `/tested_inputs/85/path` | `"tools/TestedInputIdentity.psm1"` |
| `/tested_inputs/85/mode` | `"text_utf8_lf"` |
| `/tested_inputs/85/size_bytes` | `6567` |
| `/tested_inputs/85/sha256` | `"45160531c01d36f7eb1c0d3d2a115fd6d7541de7f2883081b5fb57a7f5cb0898"` |
| `/tested_inputs/86/path` | `"tools/ToolchainIntegrity.psm1"` |
| `/tested_inputs/86/mode` | `"text_utf8_lf"` |
| `/tested_inputs/86/size_bytes` | `3009` |
| `/tested_inputs/86/sha256` | `"c3fc2f6b8d97c27e2f1d5887c05de4c91cfa8f4f6b814c21208fb3f6d533dc4c"` |
| `/tested_inputs/87/path` | `"tools/UpstreamBox3DGate.psm1"` |
| `/tested_inputs/87/mode` | `"text_utf8_lf"` |
| `/tested_inputs/87/size_bytes` | `7219` |
| `/tested_inputs/87/sha256` | `"324fd58c0dcee1ea712e36df53390ee4deff6faac604e4f32894f57a756c7163"` |
| `/tested_inputs/88/path` | `"tools/VerticalSliceGate.psm1"` |
| `/tested_inputs/88/mode` | `"text_utf8_lf"` |
| `/tested_inputs/88/size_bytes` | `64476` |
| `/tested_inputs/88/sha256` | `"624df6fdbc6d6ce9a639b3bc972e3ed4c1ac821e5ef9b78164134ef8292bac97"` |
| `/tested_inputs/89/path` | `"tools/bootstrap.ps1"` |
| `/tested_inputs/89/mode` | `"text_utf8_lf"` |
| `/tested_inputs/89/size_bytes` | `15698` |
| `/tested_inputs/89/sha256` | `"df335d69a457724bfc9d8ec05463adde0728feb6c217c772f910777715f80246"` |
| `/tested_inputs/90/path` | `"tools/box3d-v0.1.0-compile-sources.txt"` |
| `/tested_inputs/90/mode` | `"text_utf8_lf"` |
| `/tested_inputs/90/size_bytes` | `1339` |
| `/tested_inputs/90/sha256` | `"8bc4897fbc25895f75fab44e541c12d3b0e528e2692bbabbe9df632871a7d1f0"` |
| `/tested_inputs/91/path` | `"tools/build.ps1"` |
| `/tested_inputs/91/mode` | `"text_utf8_lf"` |
| `/tested_inputs/91/size_bytes` | `1456` |
...
| `/tested_inputs/93/sha256` | `"d571b34deb9f4cf708da2942b892016a13edae05472133b0e6887b3e4050b36d"` |
| `/tested_inputs/94/path` | `"tools/test.ps1"` |
| `/tested_inputs/94/mode` | `"text_utf8_lf"` |
| `/tested_inputs/94/size_bytes` | `23185` |
| `/tested_inputs/94/sha256` | `"e2220526d429cab96ce083db8c86fda7e57bbd424d0951b93e694418308d7a35"` |
| `/tested_inputs/95/path` | `"tools/toolchain.lock.json"` |
| `/tested_inputs/95/mode` | `"text_utf8_lf"` |
| `/tested_inputs/95/size_bytes` | `3047` |
| `/tested_inputs/95/sha256` | `"4242a98bf001fb9064227baf5f77ce5f28bac3abdd81c17ae2b3399b31d4cb01"` |
